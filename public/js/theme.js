...
window.Chatter.theme = {
  ...
  SVG_ICONS: {
    ...
    MOON: '<svg class="lucide lucide-moon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></svg>',
  },
  ...
  applyTheme(theme, save = true) {
    ...
    if (toggleIcon) {
      // In dark mode, show sun icon to prompt switching to light; in light mode, show moon icon
      toggleIcon.innerHTML = validTheme === this.THEMES.DARK ? this.SVG_ICONS.SUN : this.SVG_ICONS.MOON;
    }
